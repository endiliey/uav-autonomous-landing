...
#define LANDING_HEIGHT_VALUE 300 // please change this with the value of object height when the drones are very near with the object (like ~20cm distant apart)
...
double Kp = 2.5 ; // P constant
double Ki = 6; // I constant 
double Kd = 0.8; // D constant
