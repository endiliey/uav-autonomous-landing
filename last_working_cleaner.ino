...
#define LANDING_HEIGHT_VALUE 500 // set the desired height of landing pad for the the drone to land
#define LANDING_WIDTH_VALUE 500 // set the desired width of landing pad for the drone to land
#define LANDING_SIZE_VALUE 25000 // set the desired condition size of landing pad to land 
#define onState 1  //set polarity of the pulses: 1 is positive, 0 is negative
#define sigPin 8  //set PPM signal output pin on the arduino
#define LANDING_X_VALUE 2 // set the desired landing area (more of error-tolerance within X)
#define LANDING_Y_VALUE 2 // set the desired landing area (Y error-tolerance)
...
#define consKp 1.3 // set the proportional gain constant when its quite close
#define consKi 6.2 // set the integral gain constant when its quite close
#define consKd 1.02 // set the derivative gain constant when its quite close
#define aggKp 1.5 // set the proportional gain constant when its quite far
#define aggKi 7.2 // set the integral gain constant when its quite far
#define aggKd 1.03 // set the derivative gain constant when its quite far
